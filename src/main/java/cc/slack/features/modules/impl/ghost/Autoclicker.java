...
public class Autoclicker extends Module {
    ...
    public final ModeValue<String> autoblockMode = new ModeValue<>("Autoblock", new String[]{"Off", "Click", "Normal", "BlockHit", "Timed"});
    public final BooleanValue autoblockOnClick = new BooleanValue("Block On Mouse Down", true);
    public final BooleanValue autoblockOnDanger = new BooleanValue("Block On Danger Only", false);
    ...
    public Autoclicker() {
        super();
        addSettings(targetCPS, randomizeAmount, randomizeMode, onlySword, autoblockMode, autoblockOnClick, autoblockOnDanger, triggerBot, displayMode);
    }
    ...
    public void onRender(RenderEvent event) {
        if (
            ...
            if (leftClickTimer.hasReached(leftClickDelay)) {
                ...
                if (autoblockMode.getValue().equals("Click") && (!autoblockOnClick.getValue() || GameSettings.isKeyDown(mc.gameSettings.keyBindUseItem)) && (mc.thePlayer.hurtTime < 2 || !autoblockOnDanger.getValue())) KeyBinding.onTick(mc.gameSettings.keyBindUseItem.getKeyCode());
            }
            ...
            switch (autoblockMode.getValue().toLowerCase()) {
                ...
                case "blockhit":
                    ...
                    break;
                case "timed":
                    rightMouseDown = mc.thePlayer.hurtTime < 2;
                    break;
            }
            rightMouseDown = rightMouseDown && (mc.thePlayer.hurtTime < 2 || !autoblockOnDanger.getValue());
