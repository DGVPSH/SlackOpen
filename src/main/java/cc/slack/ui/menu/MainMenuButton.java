...
public class MainMenuButton extends Gui
{
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY)
    {
        if (this.visible)
        {
            ...
            RenderUtil.drawRoundedRect(this.xPosition - 1, this.yPosition + MainMenu.animY - 1 , this.xPosition + width + 1, this.yPosition + this.height+ MainMenu.animY + 1, 5, ColorUtil.getMaterial(true).getRGB());
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
            RenderUtil.drawRoundedRect(this.xPosition, this.yPosition + MainMenu.animY, this.xPosition + width * hoverPercent, this.yPosition + this.height+ MainMenu.animY, 5 * hoverPercent, ColorUtil.getMaterial(false).getRGB());
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
